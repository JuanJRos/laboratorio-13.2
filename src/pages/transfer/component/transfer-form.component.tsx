      ...
      <form onSubmit={handleSubmit}>
        <div className={classes.formContainer}>
          <div>
            ...
            <select name="accountId" onChange={handleFieldChange} className={classes.large} value={transfer.accountId}>
          ...
          <div>
            ...
            <input name="iban" type="text" onChange={handleFieldChange} className={classes.large}/>
